...
function App() {
  ...
  let clubsContent = [
    "동아리명에 맞게 서로의 재능을 나누며 성장하고 더 많은 발전 가능성의 길을 열어 보다 나은 가치를 도출하기 위해 노력하는 동아리입니다. 프로젝트를 함께 진행할 팀원을 쉽게 모으고, 다양한 협업을 통해 동아리 구성원들의 능력과 관계를 발전시키는 것이 목표입니다. 자유로운 분위기 속에서 원활한 협동을 할 수 있으며, 포트폴리오를 채우고 개발 및 디자인 능력을 키울 수 있도록 여러 프로젝트를 진행하고 있습니다. 수상 이력을 쌓아가며 자신의 가치를 높이기 위해 활동합니다. 나누며 성장하는 것은 중요한 가치입니다. 하나에서만 머무르지 않고 그 이상을 나누며 스스로 성장할 수 있는 길을 만듭니다. 나누며 성장하는 우리, MAS입니다.",
