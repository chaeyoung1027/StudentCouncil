      ...
      <>
        ...
        <section id="section02" class="demo" style={{backgroundImage: `url(${about})`, objectFit: 'none' }}>
            ...
            <Box style={{position: 'absolute', top: '0', width: '100vw', height: '100vh', marginTop: '-2rem'}}>
              ...
              <div style={{color : 'white', fontWeight: 'lighter', fontSize: '0.9rem', width: "21rem", lineHeight: "1.5rem", opacity: '0.7'}}>
                ...
                진실을 전하기 위해 눈을 맞추었습니다. 이제 남은 것은 여러분과 나눴던 약속을 실천하는 일이라고 생각합니다. 
                <br/>
                <br/>
                <br/>
                그래서 저희 32기 학생회는 여러분과의 약속인 '미림 학생 주도 잡지 제작' 공약을 이행하고자 웹사이트를 제작하였습니다.
                웹사이트를 통해 학교 생활과 더블어 행사 활동이나 학교에서의 재미난 이야깃거리를 얻을 수 있으며, 미림에서 보낸 따듯한 추억들을 저장할 수 있도록 제작하였습니다.
        ...
        <section id="section05" class="demo" style={{backgroundImage: `url(${about})`, objectFit: 'none' }}>
            ...
            <Box style={{position: 'absolute', top: '0', width: '100vw', height: '100vh', marginTop: '-2rem'}}>
              ...
              <div style={{color : 'white', fontWeight: 'lighter', fontSize: '0.9rem', width: "20rem", lineHeight: "1.5rem"}}>
                학생회 총책임 박향규선생님, 학생회 담당이신 김민혜 선생님께 감사의 말씀을 드립니다.<br/>
                <br/>
                <br/>
                32기 학생회가 서투른 점도, 미숙한 점도 많았지만 미림의 모든 학생 여러분과 선생님들의 도움으로 1년이라는 시간 동안 성장해나가는 학생회가 될 수 있었습니다. 남은 반년의 시간도 함께 좋은 학창시절을 만들어나갈 수 있도록 노력하겠습니다.
                앞으로의 미림 학생회에게 응원의 말을 남기며 신입생과 재학생 모두 행복하게 웹사이트를 이용해주시길 바라겠습니다. 감사합니다.
                <br/>
                <br/>
                <br/>
