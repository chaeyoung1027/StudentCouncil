...
import AliceCarousel from "./Activity_Carousel";
...
function ClubDetail(props) {
  ...
  let Instead = [i48, i49];
  let campaign = [i50, i51, i52];
  let Transition = [i53, i54, i55, i56];
    ...
    <Container>
      ...
      >
        <div className="explain">
          ...
          <div className="exp">{props.actexp[id]}</div>
        </div>
      </div>
